...
para_names = {'sig','theta','kai','inv_zeta',...
     ...
     'gamma_p','ksi_p','phi_r','phi_pi','phi_y','z_star_bar','psai_bar', ...
     'eta','n_k','muu_E','r_E_bar', ...
     'rho_b','rho_g','rho_w','rho_p','rho_r','rho_nu','rho_z','rho_psai', ...
     'rho_efp','rho_nw', ...
     'sig_b','sig_g','sig_w','sig_p','sig_r', ...
     'sig_nu','sig_z','sig_psai','sig_efp','sig_nw'};
...
syms z_star psai l l_bar pii pi_bar r_n r_n_bar r_E c_y i_y ...
...
syms c_ta lambda_ta w_ta b_ta Et_r_E_t1a q_ta n_ta r_k_ta u_ta ...
     ...
     z_b_ta z_g_ta z_w_ta z_p_ta z_nu_ta z_r_ta z_z_ta z_psai_ta ...
     z_efp_ta z_nw_ta z_star_ta l_ta ...
     Et_c_t1a Et_lambda_t1a Et_w_t1a Et_q_t1a Et_r_k_t1a Et_pi_t1a ...
     Et_i_t1a Et_z_b_t1a Et_z_psai_t1a Et_z_star_t1a 

syms eta_c eta_lambda eta_w eta_q eta_r_k eta_pi eta_i ...
     eta_z_b eta_z_psai eta_z_star

syms epsailon_b epsailon_g epsailon_w epsailon_p epsailon_nu epsailon_r ...
     epsailon_z epsailon_psai epsailon_efp epsailon_nw
 
syms  Et_r_n_t1 Et_r_n_t1a eta_r

syms Et_chi_t1 chi_t eta_chi Et_chi_t1a chi_ta ...
      z_i_t z_i_ta eta_chi epsailon_i rho_i sig_i
...
Epsailon_t = [epsailon_b; epsailon_g; epsailon_w; epsailon_p; epsailon_nu; ...
             epsailon_r; epsailon_z; epsailon_psai; epsailon_i];
...
Eq_S3 = -w_t+w_ta-pi_t+gamma_w*pi_ta-z_star_t+z_star*pii/r_n* ...
 ...
 Eq_S5 = -chi_t + (1-(1-delta)/r_n/psai)*r_k_t+...   
        ((1-delta)/r_n/psai)*q_t - q_ta - z_psai_t;  

Eq_S8 = w_t + l_t - (r_k_t+u_t+k_ta-z_star_t-z_psai_t);
...
Eq_S12 = -y_t + (1+phi_o_y)*((1-alph)*l_t+alph*(u_t+k_ta-z_star_t-z_psai_t));
Eq_S13 = -y_t + c_y*c_t + i_y*i_t + z_g_t;

Eq_S14 = -k_t + (1-delta-r_n*psai/pii)/z_star/psai*u_t+ ...
         (1-delta)/z_star/psai*(k_ta-z_star_t-z_psai_t)+ ...
         (1-(1-delta)/z_star/psai)*(i_t+z_nu_t);

Eq_S15 = -q_t + inv_zeta*(i_t-i_ta+z_star_t+z_psai_t)-...
         inv_zeta*z_star*pii/r_n*(Et_i_t1-i_t+Et_z_star_t1+...
         Et_z_psai_t1)-z_nu_t+z_i_t;
...
%% Persistent Shocks(9)
Eq_P1 = -z_b_t + rho_b*z_b_ta + epsailon_b;
Eq_P2 = -z_g_t + rho_g*z_g_ta + epsailon_g;
Eq_P3 = -z_w_t + rho_w*z_w_ta + epsailon_w;
Eq_P4 = -z_p_t + rho_p*z_p_ta + epsailon_p;
Eq_P5 = -z_nu_t + rho_nu*z_nu_ta + epsailon_nu;
Eq_P6 = -z_r_t + rho_r*z_r_ta + epsailon_r;
Eq_P7 = -z_z_t + rho_z*z_z_ta + epsailon_z;
Eq_P8 = -z_psai_t + rho_psai*z_psai_ta + epsailon_psai;
Eq_P9 = -z_i_t + rho_i*z_i_ta + epsailon_i;
%Eq_P10 = -z_efp_t + rho_efp*z_efp_ta + epsailon_efp;
%Eq_P11 = -z_nw_t + rho_nw*z_nw_ta + epsailon_nw;

%% Identities(3)
Eq_I1 = -z_star_t + z_z_t + alph/(1-alph)*z_psai_t;
...
Z0 = [z_star_t + y_t - y_ta; ...             % out
      z_star_t + c_t - c_ta; ...             % cons
      z_star_t + z_psai_t + i_t - i_ta;...    % inv
      z_star_t + w_t - w_ta;...              % wage
      pi_t;...                               % pi
     r_n_t  ] ;                           % nominal rate
%       y_t - y_star_t];                     % potencial GDP
%       z_star_t + b_t - b_ta;];           % real borrowing
